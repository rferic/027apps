...
interface TodoStatusChangeEmailProps {
  taskTitle: string
  groupName: string
  oldStatus: string
  newStatus: string
...
export function TodoStatusChangeEmail({
  taskTitle,
  groupName,
  oldStatus,
  newStatus,
                ...
                <table cellPadding="0" cellSpacing="0" style={cardTable}>
                  <tr>
                    <td align="center" style={cardPadding}>
                      ...
                      <span style={introText}>{oldStatus} → {newStatus}</span>
                    </td>
                  </tr>
                </table>
              </td>
...
const introText: CSSProperties = { color: '#64748b', fontSize: '13px', lineHeight: '1.5', display: 'block', marginTop: '14px' }
...
export default TodoStatusChangeEmail
